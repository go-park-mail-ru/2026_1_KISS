...
func (m *MockUserRepository) UpdateVerified(ctx context.Context, userID int64) error {
	m.ctrl.T.Helper()
...
func (mr *MockUserRepositoryMockRecorder) UpdateVerified(ctx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
