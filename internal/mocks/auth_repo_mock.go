...
// Source: github.com/go-park-mail-ru/2026_1_KISS/internal/auth/repository (interfaces: UserRepository,SessionRepository,VerificationRepository,EventRepository,SubscriptionViewRepository,OAuthAccountRepository,OAuthStateRepository)
//
// Generated by this command:
//
//	mockgen -destination=../../mocks/auth_repo_mock.go -package=mocks github.com/go-park-mail-ru/2026_1_KISS/internal/auth/repository UserRepository,SessionRepository,VerificationRepository,EventRepository,SubscriptionViewRepository,OAuthAccountRepository,OAuthStateRepository
//
...
import (
	...
	repository "github.com/go-park-mail-ru/2026_1_KISS/internal/auth/repository"
...
// MockSubscriptionViewRepository is a mock of SubscriptionViewRepository interface.
type MockSubscriptionViewRepository struct {
	ctrl     *gomock.Controller
	recorder *MockSubscriptionViewRepositoryMockRecorder
	isgomock struct{}
}

// MockSubscriptionViewRepositoryMockRecorder is the mock recorder for MockSubscriptionViewRepository.
type MockSubscriptionViewRepositoryMockRecorder struct {
	mock *MockSubscriptionViewRepository
}

// NewMockSubscriptionViewRepository creates a new mock instance.
func NewMockSubscriptionViewRepository(ctrl *gomock.Controller) *MockSubscriptionViewRepository {
	mock := &MockSubscriptionViewRepository{ctrl: ctrl}
	mock.recorder = &MockSubscriptionViewRepositoryMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockSubscriptionViewRepository) EXPECT() *MockSubscriptionViewRepositoryMockRecorder {
	return m.recorder
}

// GetActive mocks base method.
func (m *MockSubscriptionViewRepository) GetActive(ctx context.Context, userID int64) (*repository.ActiveSubscription, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetActive", ctx, userID)
	ret0, _ := ret[0].(*repository.ActiveSubscription)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetActive indicates an expected call of GetActive.
func (mr *MockSubscriptionViewRepositoryMockRecorder) GetActive(ctx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetActive", reflect.TypeOf((*MockSubscriptionViewRepository)(nil).GetActive), ctx, userID)
}

// MockOAuthAccountRepository is a mock of OAuthAccountRepository interface.
type MockOAuthAccountRepository struct {
	ctrl     *gomock.Controller
	recorder *MockOAuthAccountRepositoryMockRecorder
	isgomock struct{}
}

// MockOAuthAccountRepositoryMockRecorder is the mock recorder for MockOAuthAccountRepository.
type MockOAuthAccountRepositoryMockRecorder struct {
	mock *MockOAuthAccountRepository
}

// NewMockOAuthAccountRepository creates a new mock instance.
func NewMockOAuthAccountRepository(ctrl *gomock.Controller) *MockOAuthAccountRepository {
	mock := &MockOAuthAccountRepository{ctrl: ctrl}
	mock.recorder = &MockOAuthAccountRepositoryMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockOAuthAccountRepository) EXPECT() *MockOAuthAccountRepositoryMockRecorder {
	return m.recorder
}

// Create mocks base method.
func (m *MockOAuthAccountRepository) Create(ctx context.Context, acc *domain.OAuthAccount) (int64, error) {
	m.ctrl.T.Helper()
...
// Create indicates an expected call of Create.
func (mr *MockOAuthAccountRepositoryMockRecorder) Create(ctx, acc any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Create", reflect.TypeOf((*MockOAuthAccountRepository)(nil).Create), ctx, acc)
}

// DeleteByID mocks base method.
func (m *MockOAuthAccountRepository) DeleteByID(ctx context.Context, id, userID int64) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteByID", ctx, id, userID)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteByID indicates an expected call of DeleteByID.
func (mr *MockOAuthAccountRepositoryMockRecorder) DeleteByID(ctx, id, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteByID", reflect.TypeOf((*MockOAuthAccountRepository)(nil).DeleteByID), ctx, id, userID)
}

// GetByProviderID mocks base method.
func (m *MockOAuthAccountRepository) GetByProviderID(ctx context.Context, provider, providerID string) (*domain.OAuthAccount, error) {
	m.ctrl.T.Helper()
...
func (mr *MockOAuthAccountRepositoryMockRecorder) GetByProviderID(ctx, provider, providerID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetByProviderID", reflect.TypeOf((*MockOAuthAccountRepository)(nil).GetByProviderID), ctx, provider, providerID)
}

// ListByUserID mocks base method.
func (m *MockOAuthAccountRepository) ListByUserID(ctx context.Context, userID int64) ([]domain.OAuthAccount, error) {
	m.ctrl.T.Helper()
...
func (mr *MockOAuthAccountRepositoryMockRecorder) ListByUserID(ctx, userID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListByUserID", reflect.TypeOf((*MockOAuthAccountRepository)(nil).ListByUserID), ctx, userID)
}
...
func (m *MockOAuthStateRepository) Consume(ctx context.Context, state string) (*domain.OAuthState, error) {
	m.ctrl.T.Helper()
...
func (mr *MockOAuthStateRepositoryMockRecorder) Consume(ctx, state any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Consume", reflect.TypeOf((*MockOAuthStateRepository)(nil).Consume), ctx, state)
}

// Save mocks base method.
func (m *MockOAuthStateRepository) Save(ctx context.Context, st *domain.OAuthState, ttl time.Duration) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Save", ctx, st, ttl)
	ret0, _ := ret[0].(error)
	return ret0
}

// Save indicates an expected call of Save.
func (mr *MockOAuthStateRepositoryMockRecorder) Save(ctx, st, ttl any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Save", reflect.TypeOf((*MockOAuthStateRepository)(nil).Save), ctx, st, ttl)
}
