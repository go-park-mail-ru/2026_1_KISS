...
### Запускаем пока приложение в докере, ибо все runner'ы запускаются там и вся конфигурация заточена на это. В будущем (при распиле на микросервисы), возможно, добавим возможность локального запуска без докера.
